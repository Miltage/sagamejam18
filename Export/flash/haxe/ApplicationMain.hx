...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		lime.system.System.__registerEntryPoint ("NyanCat", create);
		
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed ("NyanCat", null, 400, 400);
		#end
		#else
		create (null);
		#end
	...
	public static function create (config):Void {
		...
		app.meta["file"] = "NyanCat";
		app.meta["name"] = "Nyan Cat";
		app.meta["packageName"] = "org.openfl.samples.nyancat";
